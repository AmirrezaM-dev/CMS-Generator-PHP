...
oPaginate:{sFirst:"اولین",sLast:"آخرین",sNext:"بعدی",sPrevious:"قبلی"},sEmptyTable:"هیچ دیتایی در این جدول وجود ندارد",sInfo:"نمایش _START_ تا _END_ از _TOTAL_ ورودی",sInfoEmpty:"نمایش 0 تا 0 از 0 ورودی",sInfoFiltered:"(فیلتر شده از مجموع _MAX_ ورودی)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"نمایش _MENU_ ورودی",sLoadingRecords:"بارگذاری ...",sProcessing:"انجام عملیات ...",sSearch:"جست و جو :",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"هیچ دیتایی پیدا نشد"},oSearch:h.extend({},
