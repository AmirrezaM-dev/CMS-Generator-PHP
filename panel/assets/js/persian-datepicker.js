...
var Input = function () {
    ...
    _createClass(Input, [{
        ...
        value: function getInputPosition() {
            var $offsets=$(this.elem).offset();
            $offsets.right=($(window).width() - ($(this.elem).offset().left + $(this.elem).outerWidth()))+200;
            return $offsets;
        }
        ...
        value: function setPickerBoxPosition() {
            ...
            if(language=="en"){
                ...
                if(sidebar_minimize_def){
                    ...
                    if (this.model.options.position === 'auto') {
                        this.$container.css({
                            right: inputPosition.left + 'px',
                            left: 'inherit',
                            top: inputSize.height + inputPosition.top + 'px'
                        });
                    } else {
                        this.$container.css({
                            right: this.model.options.position[1] + inputPosition.left + 'px',
                            left: 'inherit',
                            top: this.model.options.position[0] + inputPosition.top + 'px'
                        });
                    }
