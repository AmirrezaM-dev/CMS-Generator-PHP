	...
	<div class="col-md-12">
		<div class="card">
			<div class="card-header">
				<div class="row">
					<div class="col-md-6 col-form-label text-center-custom <?php if($GLOBALS['user_language']=='fa'){?>text-right<?php }else{?>text-left<?php } ?>">
						<h4 class="card-title data-text" data-text-en="<?php print_r("<b>editing:</b> ".$table_get['description_name_en']."(". preg_replace('/' . preg_quote($sub_name, '/') . '/', "", $table_name, 1).")"); ?>" data-text-fa="<?php print_r("<b>ویرایش:</b> ".$table_get['description_name_fa']."(". preg_replace('/' . preg_quote($sub_name, '/') . '/', "", $table_name, 1).")"); ?>">
							<?php print_r($GLOBALS['user_language']=="en" ? "<b>editing:</b> ".$table_get['description_name_en']."(". preg_replace('/' . preg_quote($sub_name, '/') . '/', "", $table_name, 1).")":"<b>ویرایش:</b> ".$table_get['description_name_fa']."(". preg_replace('/' . preg_quote($sub_name, '/') . '/', "", $table_name, 1).")"); ?>
						</h4>
					</div>
			...
			?>
														...
														<div class="row custom-font-size mb-5">
															<div class="col-md-2 pt-0 col-form-label text-center-custom <?php if($GLOBALS['user_language']=='fa'){?>label-on-right<?php }else{?>label-on-left<?php } ?>">
																<label class="col-sm-12 data-text" data-text-en="<?php print_r($table_column['description_name_en']); ?> <?php if(isset($op_admin) && $op_admin){ ?><small class='developer_mode'>(<?php print_r(preg_replace('/' . preg_quote($sub_name, '/') . '/', "", $table_column['current_name'], 1)); ?>)</small><?php }?><?php if($table_column['importants']){?> *<?php } ?>" data-text-fa="<?php print_r($table_column['description_name_fa']); ?> <?php if(isset($op_admin) && $op_admin){ ?><small class='developer_mode'>(<?php print_r(preg_replace('/' . preg_quote($sub_name, '/') . '/', "", $table_column['current_name'], 1)); ?>)</small><?php }?><?php if($table_column['importants']){?> *<?php } ?>">
																	...
																	<?php if(strlen($primary)){?>
																		<h4 class="card-title data-text" data-text-en="<?php print_r("<small>(".$primary.")</small>"); ?>" data-text-fa="<?php print_r("<small>(".$primary.")</small>"); ?>">
																			<?php print_r($GLOBALS['user_language']=="en" ? "<small>(".$primary.")</small>":"<small>(".$primary.")</small>"); ?>
																		</h4>
																	<?php }?>
																	<?php if($table_column['importants']){?> *<?php } ?>
																</label>
															</div>
																...
																<?php
																	switch ($table_column['mode']) {//tables_mode_code
																		...
																		case '1':case 1://info search case 1 for see all things about this part
																			?>
																				<textarea id="save_-_<?php print_r(preg_replace('/' . preg_quote($sub_name, '/') . '/', "", $table_column['current_name'], 1)); ?>_-_<?php print_r($table_column['id']); ?>_-_<?php print_r($table_column['mode']); ?>_-_<?php print_r($dataGet['id']); ?>" class="form-control input-group save_data_table <?php if($table_column['importants']){?>save_important<?php } ?>"><?php print_r(preg_replace('/' . preg_quote($sub_name, '/') . '/', "", $dataGet[$table_column['current_name']], 1)); ?></textarea>
																				<label class="hide reset_data"><?php print_r(htmlspecialchars_decode(preg_replace('/' . preg_quote($sub_name, '/') . '/', "", $dataGet[$table_column['current_name']], 1))); ?></label>
																		...
																		case '2':case 2://info search case 2 for see all things about this part
																			?>
																				<input id="save_-_<?php print_r(preg_replace('/' . preg_quote($sub_name, '/') . '/', "", $table_column['current_name'], 1)); ?>_-_<?php print_r($table_column['id']); ?>_-_<?php print_r($table_column['mode']); ?>_-_<?php print_r($dataGet['id']); ?>" type="number" class="form-control save_data_table <?php if($table_column['importants']){?>save_important<?php } ?>" value="<?php print_r(preg_replace('/' . preg_quote($sub_name, '/') . '/', "", $dataGet[$table_column['current_name']], 1)); ?>">
																				<label class="hide reset_data"><?php print_r(preg_replace('/' . preg_quote($sub_name, '/') . '/', "", $dataGet[$table_column['current_name']], 1)); ?></label>
																				<span class="form-text data-text text-center-custom m-i-i-column" data-text-en="<?php print_r($table_column['description_info_en']); ?>" data-text-fa="<?php print_r($table_column['description_info_fa']); ?>"><?php print_r($GLOBALS['user_language']=="en" ? $table_column['description_info_en']:$table_column['description_info_fa']); ?></span>
																			<?php
																		break;
																		case '3':case 3://info search case 3 for see all things about this part
																			...
																			?>
																				<?php print_r($yes_no['no_option']); ?><lable class="ml-2 mr-2"></lable><input id="save_-_<?php print_r(preg_replace('/' . preg_quote($sub_name, '/') . '/', "", $table_column['current_name'], 1)); ?>_-_<?php print_r($table_column['id']); ?>_-_<?php print_r($table_column['mode']); ?>_-_<?php print_r($dataGet['id']); ?>" type="checkbox" name="checkbox" class="bootstrap-switch save_data_table <?php if($table_column['importants']){?>save_important<?php } ?>" <?php if($yes_no['yes_value']==preg_replace('/' . preg_quote($sub_name, '/') . '/', "", $dataGet[$table_column['current_name']], 1) || $yes_no['yes_value']=="" && preg_replace('/' . preg_quote($sub_name, '/') . '/', "", $dataGet[$table_column['current_name']], 1)==1){?>checked<?php } ?> data-on-label="<i class='<?php print_r($yes_no['yes_fa_icon']); ?>'></i>" data-off-label="<i class='<?php print_r($yes_no['no_fa_icon']); ?>'></i>"><lable class="ml-2 mr-2"></lable><?php print_r($yes_no['yes_option']); ?>
																				<label class="hide reset_data"><?php if($yes_no['yes_value']==preg_replace('/' . preg_quote($sub_name, '/') . '/', "", $dataGet[$table_column['current_name']], 1) || $yes_no['yes_value']=="" && preg_replace('/' . preg_quote($sub_name, '/') . '/', "", $dataGet[$table_column['current_name']], 1)==1){?>checked<?php } ?></label>
																				<span class="form-text data-text text-center-custom m-i-i-column" data-text-en="<?php print_r($table_column['description_info_en']); ?>" data-text-fa="<?php print_r($table_column['description_info_fa']); ?>"><?php print_r($GLOBALS['user_language']=="en" ? $table_column['description_info_en']:$table_column['description_info_fa']); ?></span>
																			<?php
																		break;
																		case '4':case 4://info search case 4 for see all things about this part
																			...
																			if($res_selectbox_setting->rowCount()){
																				...
																				if($selectbox_setting['is_multiple']){
																					$multiple_selected_arr=explode("_-.,.-_",preg_replace('/' . preg_quote($sub_name, '/') . '/', "", $dataGet[$table_column['current_name']], 1));
																				}else{
																					$multiple_selected_arr=[];
																				}
																			}else{
																				$multiple_selected_arr=[];
																			...
																			$in_optgroup='';
																			?>
																				<select id="save_-_<?php print_r(preg_replace('/' . preg_quote($sub_name, '/') . '/', "", $table_column['current_name'], 1)); ?>_-_<?php print_r($table_column['id']); ?>_-_<?php print_r($table_column['mode']); ?>_-_<?php print_r($dataGet['id']); ?>" class="selectpicker save_data_table <?php if($table_column['importants']){?>save_important<?php } ?> data-title" data-style="btn btn-primary disable-hover" <?php if($selectbox_setting['is_multiple']){?>multiple<?php } ?> title="<?php print_r($GLOBALS['user_language']=="en" ? "Select":"انتخاب کنید"); ?>" data-size="7" data-live-search="true">
																					<?php
																												...
																												if($connected_table){
																													...
																													if(in_array($connected_table, $GLOBALS['show_tables'])){
																														...
																														while ($data=$res_data->fetch()) {
																															...
																															?>
																																<option <?php if(preg_replace('/' . preg_quote($sub_name, '/') . '/', "", $dataGet[$table_column['current_name']], 1)==$selectbox_optgroups['option_text']."_-...-_".$selectbox_option['id']."_-..-_".$value || in_array($selectbox_optgroups['option_text']."_-...-_".$selectbox_option['id']."_-..-_".$value,$multiple_selected_arr)){?>selected<?php } ?> value="<?php print_r($selectbox_optgroups['option_text']."_-...-_".$selectbox_option['id']."_-..-_".$value); ?>"><?php print_r($text); ?></option>
																															<?php
																														}
																													}
																												}
																														...
																														if($selectbox_option['connected_table']>0){
																															...
																															if($connected_table){
																																...
																																while ($data=$res_data->fetch()) {
																																	...
																																	$value=$data[$column_value];
																																	?>
																																		<option <?php if(preg_replace('/' . preg_quote($sub_name, '/') . '/', "", $dataGet[$table_column['current_name']], 1)==$optgroup_label."_-...-_".$selectbox_option['id']."_-..-_".$value || in_array($optgroup_label."_-...-_".$selectbox_option['id']."_-..-_".$value,$multiple_selected_arr)){?>selected<?php } ?> value="<?php print_r($optgroup_label."_-...-_".$selectbox_option['id']."_-..-_".$value); ?>"><?php print_r($text); ?></option>
																																	<?php
																																}
																															}
																														}else{
																						...
																						while ($selectbox_option=$res_selectbox_option->fetch()) {
																							if($selectbox_option['connected_table']>0){
																								...
																								if($connected_table){
																									...
																									if(in_array($connected_table, $GLOBALS['show_tables'])){
																										...
																										while ($data=$res_data->fetch()) {
																											...
																											$value=$data[$column_value];
																											?>
																												<option <?php if(in_array($selectbox_option['id']."_-..-_".$value, explode("_-.,.-_", preg_replace('/' . preg_quote($sub_name, '/') . '/', "", $dataGet[$table_column['current_name']], 1)))){?>selected<?php } ?> value="<?php print_r($selectbox_option['id']."_-..-_".$value); ?>"><?php print_r($text); ?></option>
																											<?php
																										}
																									}
																								}
																								...
																								$value=$selectbox_option['option_value'];
																								?>
																									<option <?php if(preg_replace('/' . preg_quote($sub_name, '/') . '/', "", $dataGet[$table_column['current_name']], 1)==$selectbox_option['id']."_-.-_".$value){?>selected<?php } ?> value="<?php print_r($selectbox_option['id']."_-.-_".$value); ?>"><?php print_r($text); ?></option>
																								<?php
																							}
																						}
																						if(isset($op_admin) && $op_admin && $table_column['current_name']=="act"){
																							foreach ($permission_power_list as $key => $value) {
																								?>
																									<option <?php if(preg_replace('/' . preg_quote($sub_name, '/') . '/', "", $dataGet[$table_column['current_name']], 1)==$value[1]){?>selected<?php } ?> value="<?php print_r($value[1]); ?>"><?php print_r($value[1]); ?></option>
																								<?php
																							}
																						}
																					?>
																		...
																		case '5':case 5://info search case 5 for see all things about this part
																			?>
																				<input id="save_-_<?php print_r(preg_replace('/' . preg_quote($sub_name, '/') . '/', "", $table_column['current_name'], 1)); ?>_-_<?php print_r($table_column['id']); ?>_-_<?php print_r($table_column['mode']); ?>_-_<?php print_r($dataGet['id']); ?>" class="form-control colorpicker save_data_table <?php if($table_column['importants']){?>save_important<?php } ?> data-title" title="<?php print_r($GLOBALS['user_language']=="en" ? "Select":"انتخاب کنید"); ?>" value='<?php print_r(preg_replace('/' . preg_quote($sub_name, '/') . '/', "", $dataGet[$table_column['current_name']], 1)); ?>'>
																				<script>
																					$('#save_-_<?php print_r(preg_replace('/' . preg_quote($sub_name, '/') . '/', "", $table_column['current_name'], 1)); ?>_-_<?php print_r($table_column['id']); ?>_-_<?php print_r($table_column['mode']); ?>_-_<?php print_r($dataGet['id']); ?>').spectrum({
																						locale: language,
																						type: "flat",
																		...
																		case '6':case 6://info search case 6 for see all things about this part
																			?>
																				<input id="save_-_<?php print_r(preg_replace('/' . preg_quote($sub_name, '/') . '/', "", $table_column['current_name'], 1)); ?>_-_<?php print_r($table_column['id']); ?>_-_<?php print_r($table_column['mode']); ?>_-_<?php print_r($dataGet['id']); ?>" type="password" class="form-control save_data_table <?php if($table_column['importants']){?>save_important<?php } ?>" onkeypress="$('#save_-_<?php print_r(preg_replace('/' . preg_quote($sub_name, '/') . '/', "", $table_column['current_name'], 1)); ?>_-_<?php print_r($table_column['id']); ?>_-_<?php print_r($table_column['mode']); ?>_-_<?php print_r($dataGet['id']); ?>_-_keep_old_password').prop('checked', false).change();">
																			...
																			?>
																				<div class="input-group mb-3 <?php if($table_column['importants']){?>save_important<?php } ?>">
																					<div class="custom-file">
																						<input class="custom-file-input on-file-change save_data_table <?php if($table_column['importants']){?>save_important<?php } ?>" id="save_-_<?php print_r(preg_replace('/' . preg_quote($sub_name, '/') . '/', "", $table_column['current_name'], 1)); ?>_-_<?php print_r($table_column['id']); ?>_-_<?php print_r($table_column['mode']); ?>_-_<?php print_r($dataGet['id']); ?>_file" data-dataID="save_-_<?php print_r(preg_replace('/' . preg_quote($sub_name, '/') . '/', "", $table_column['current_name'], 1)); ?>_-_<?php print_r($table_column['id']); ?>_-_<?php print_r($table_column['mode']); ?>_-_<?php print_r($dataGet['id']); ?>" type="file" <?php if(getSetting("op_admin")!=$_SESSION["username"] && $size_limit!="" && !empty($size_limit) && intval($size_limit)==0){ ?>onchange="if(typeof $(this)[0].files[0] !== 'undefined'){if(parseInt($(this)[0].files[0].size/1024/1024)>parseInt('<?php print_r($size_limit); ?>')){$('#' + $(this).attr('data-dataID') + '_file').val('');$('#' + $(this).attr('data-dataID') + '_file').next().html(language=='en' ? 'Choose':'انتخاب');$(this).prev().removeClass('activated-file');$(this).addClass('activated-file');$('#' + $(this).attr('data-dataID') + '_-_keep_old_file').prop('checked', false).change();Swal.fire({text: (language=='en' ? 'Maximum allowed size is : <?php print_r($size_limit); ?> MB':'حد مجاز آپلود <?php print_r($size_limit); ?> مگابایت است'),icon: 'error',showConfirmButton: false,showCancelButton: false,timer: 1500});}}"<?php } ?> <?php if(getSetting("op_admin")!=$_SESSION["username"] && $file_types_limit!="" && !empty($file_types_limit)){ ?>accept="<?php print_r($file_types_limit); ?>"<?php } ?> >
																						<label class="custom-file-label data-text" data-text-en="Choose" data-text-fa="انتخاب" for="save_-_<?php print_r(preg_replace('/' . preg_quote($sub_name, '/') . '/', "", $table_column['current_name'], 1)); ?>_-_<?php print_r($table_column['id']); ?>_-_<?php print_r($table_column['mode']); ?>_-_<?php print_r($dataGet['id']); ?>_file"><?php print_r($GLOBALS['user_language']=="en" ? "Choose":"انتخاب"); ?></label>
																					</div>
																					<input class="form-control save_data_table <?php if($table_column['importants']){?>save_important<?php } ?> data-placeholder on-fileurl-change" data-placeholder-en="File URL" data-placeholder-fa="آدرس فایل" placeholder="<?php print_r($GLOBALS['user_language']=="en" ? "File URL":"آدرس فایل"); ?>" id="save_-_<?php print_r(preg_replace('/' . preg_quote($sub_name, '/') . '/', "", $table_column['current_name'], 1)); ?>_-_<?php print_r($table_column['id']); ?>_-_<?php print_r($table_column['mode']); ?>_-_<?php print_r($dataGet['id']); ?>_url" data-dataID="save_-_<?php print_r(preg_replace('/' . preg_quote($sub_name, '/') . '/', "", $table_column['current_name'], 1)); ?>_-_<?php print_r($table_column['id']); ?>_-_<?php print_r($table_column['mode']); ?>_-_<?php print_r($dataGet['id']); ?>" type="text" value="<?php print_r(preg_replace('/' . preg_quote($sub_name, '/') . '/', "", $dataGet[$table_column['current_name']], 1)); ?>">
																				</div>
																				<div id="save_-_<?php print_r(preg_replace('/' . preg_quote($sub_name, '/') . '/', "", $table_column['current_name'], 1)); ?>_-_<?php print_r($table_column['id']); ?>_-_<?php print_r($table_column['mode']); ?>_-_<?php print_r($dataGet['id']); ?>_progress" class="progress-container progress-sm not-90 hide">
																					<div class="progress">
																		...
																		case '8':case 8://info search case 8 for see all things about this part
																			?>
																				<ckeditor id="save_-_<?php print_r(preg_replace('/' . preg_quote($sub_name, '/') . '/', "", $table_column['current_name'], 1)); ?>_-_<?php print_r($table_column['id']); ?>_-_<?php print_r($table_column['mode']); ?>_-_<?php print_r($dataGet['id']); ?>" class="form-control ckeditor_start input-group save_data_table <?php if($table_column['importants']){?>save_important<?php } ?>"><?php print_r(preg_replace('/' . preg_quote($sub_name, '/') . '/', "", $dataGet[$table_column['current_name']], 1)); ?></ckeditor>
																				<label class="hide reset_data"><?php print_r(htmlspecialchars_decode(preg_replace('/' . preg_quote($sub_name, '/') . '/', "", $dataGet[$table_column['current_name']], 1))); ?></label>
																				<span class="form-text data-text text-center-custom m-i-i-column" data-text-en="<?php print_r($table_column['description_info_en']); ?>" data-text-fa="<?php print_r($table_column['description_info_fa']); ?>"><?php print_r($GLOBALS['user_language']=="en" ? $table_column['description_info_en']:$table_column['description_info_fa']); ?></span>
																				<script>
																					$(document).ready(function () {
																						CKEDITOR.replace("save_-_<?php print_r(preg_replace('/' . preg_quote($sub_name, '/') . '/', "", $table_column['current_name'], 1)); ?>_-_<?php print_r($table_column['id']); ?>_-_<?php print_r($table_column['mode']); ?>_-_<?php print_r($dataGet['id']); ?>");
																						$("#save_-_<?php print_r(preg_replace('/' . preg_quote($sub_name, '/') . '/', "", $table_column['current_name'], 1)); ?>_-_<?php print_r($table_column['id']); ?>_-_<?php print_r($table_column['mode']); ?>_-_<?php print_r($dataGet['id']); ?>").addClass("ckeditor_started").removeClass("ckeditor_start");
																						if(language=="fa"){
																		...
																		case '9':case 9://info search case 9 for see all things about this part
																			...
																			$value_array_case9=explode("_-...-_",$dataGet[$table_column['current_name']]);
																				...
																				if($checkbox_options_setting['is_multiple']){
																					?>
																						<div class="form-check-inline form-check form-check-radio">
																							<label class="form-check-label">
																								<input data-likeid="save_-_<?php print_r(preg_replace('/' . preg_quote($sub_name, '/') . '/', "", $table_column['current_name'], 1)); ?>_-_<?php print_r($table_column['id']); ?>_-_<?php print_r($table_column['mode']); ?>_-_<?php print_r($dataGet['id']); ?>" <?php if(in_array($checkbox_options['option_value'],$value_array_case9)){?>checked<?php } ?> type="radio" class="form-check-input save_data_table <?php if($table_column['importants']){?>save_important<?php } ?>" value="<?php print_r($checkbox_options['option_value']); ?>" data-falsevalue="<?php print_r($checkbox_options['option_false']); ?>" name="save_-_<?php print_r(preg_replace('/' . preg_quote($sub_name, '/') . '/', "", $table_column['current_name'], 1)); ?>_-_<?php print_r($table_column['id']); ?>_-_<?php print_r($table_column['mode']); ?>_-_<?php print_r($dataGet['id']); ?>">
																					...
																					?>
																						<div class="form-check form-check-inline">
																							<label class="form-check-label">
																								<input data-likeid="save_-_<?php print_r(preg_replace('/' . preg_quote($sub_name, '/') . '/', "", $table_column['current_name'], 1)); ?>_-_<?php print_r($table_column['id']); ?>_-_<?php print_r($table_column['mode']); ?>_-_<?php print_r($dataGet['id']); ?>" <?php if(in_array($checkbox_options['option_value'],$value_array_case9)){?>checked<?php } ?> type="checkbox" class="form-check-input save_data_table <?php if($table_column['importants']){?>save_important<?php } ?>" value="<?php print_r($checkbox_options['option_value']); ?>" data-falsevalue="<?php print_r($checkbox_options['option_false']); ?>">
																								<span class="form-check-sign"></span>
																								<?php print_r($checkbox_options['option_name']); ?>
																							</label>
																						</div>
																			...
																			?>
																				<label id="save_-_<?php print_r(preg_replace('/' . preg_quote($sub_name, '/') . '/', "", $table_column['current_name'], 1)); ?>_-_<?php print_r($table_column['id']); ?>_-_<?php print_r($table_column['mode']); ?>_-_<?php print_r($dataGet['id']); ?>" class="hide reset_data <?php if($table_column['importants']){?>save_important<?php } ?>"><?php print_r($dataGet[$table_column['current_name']]); ?></label>
																				<span class="form-text data-text text-center-custom m-i-i-column" data-text-en="<?php print_r($table_column['description_info_en']); ?>" data-text-fa="<?php print_r($table_column['description_info_fa']); ?>"><?php print_r($GLOBALS['user_language']=="en" ? $table_column['description_info_en']:$table_column['description_info_fa']); ?></span>
																			<?php
																		break;
																				...
																				<div class="input-group">
																					<div class="input-group-prepend">
																						<div class="input-group-text">
																							<i class="<?php print_r(strlen($dataGet[$table_column['current_name']]) ? $dataGet[$table_column['current_name']]:"far fa-question-circle"); ?>"></i>
																						</div>
																					</div>
																					<input id="save_-_<?php print_r(preg_replace('/' . preg_quote($sub_name, '/') . '/', "", $table_column['current_name'], 1)); ?>_-_<?php print_r($table_column['id']); ?>_-_<?php print_r($table_column['mode']); ?>_-_<?php print_r($dataGet['id']); ?>" type="text" class="form-control save_data_table <?php if($table_column['importants']){?>save_important<?php } ?> pl-0 pr-0 fa-on-change" value="<?php print_r(preg_replace('/' . preg_quote($sub_name, '/') . '/', "", $dataGet[$table_column['current_name']], 1)); ?>">
																				</div>
																				<label class="hide reset_data"><?php print_r($dataGet[$table_column['current_name']]); ?></label>
																				<span class="form-text data-text text-center-custom m-i-i-column" data-text-en="<?php print_r($table_column['description_info_en']); ?>" data-text-fa="<?php print_r($table_column['description_info_fa']); ?>"><?php print_r($GLOBALS['user_language']=="en" ? $table_column['description_info_en']:$table_column['description_info_fa']); ?></span>
																			<?php
																		break;
																		case '12':case 12://info search case 12 for see all things about this part
																			?>
																				<input id="save_-_<?php print_r(preg_replace('/' . preg_quote($sub_name, '/') . '/', "", $table_column['current_name'], 1)); ?>_-_<?php print_r($table_column['id']); ?>_-_<?php print_r($table_column['mode']); ?>_-_<?php print_r($dataGet['id']); ?>" type="text" class="form-control save_data_table <?php if($table_column['importants']){?>save_important<?php } ?> fa_datetimepicker" value="">
																				<div id="save_-_<?php print_r(preg_replace('/' . preg_quote($sub_name, '/') . '/', "", $table_column['current_name'], 1)); ?>_-_<?php print_r($table_column['id']); ?>_-_<?php print_r($table_column['mode']); ?>_-_<?php print_r($dataGet['id']); ?>_-_alt"></div>
																				<label class="hide reset_data"><?php print_r(htmlspecialchars_decode(preg_replace('/' . preg_quote($sub_name, '/') . '/', "", $dataGet[$table_column['current_name']], 1))); ?></label>
																				<span class="form-text data-text text-center-custom m-i-i-column" data-text-en="<?php print_r($table_column['description_info_en']); ?>" data-text-fa="<?php print_r($table_column['description_info_fa']); ?>"><?php print_r($GLOBALS['user_language']=="en" ? $table_column['description_info_en']:$table_column['description_info_fa']); ?></span>
																				<script>
																					$fa_datetimepicker["#save_-_<?php print_r(preg_replace('/' . preg_quote($sub_name, '/') . '/', "", $table_column['current_name'], 1)); ?>_-_<?php print_r($table_column['id']); ?>_-_<?php print_r($table_column['mode']); ?>_-_<?php print_r($dataGet['id']); ?>"]=$("#save_-_<?php print_r(preg_replace('/' . preg_quote($sub_name, '/') . '/', "", $table_column['current_name'], 1)); ?>_-_<?php print_r($table_column['id']); ?>_-_<?php print_r($table_column['mode']); ?>_-_<?php print_r($dataGet['id']); ?>_-_alt").persianDatepicker({
																						inline: true,
																						altField: '#save_-_<?php print_r(preg_replace('/' . preg_quote($sub_name, '/') . '/', "", $table_column['current_name'], 1)); ?>_-_<?php print_r($table_column['id']); ?>_-_<?php print_r($table_column['mode']); ?>_-_<?php print_r($dataGet['id']); ?>',
																						...
																						toolbox: {
																							submitButton: {
																								onSubmit: function (this_elem) {
																									$fa_datetimepicker["#save_-_<?php print_r(preg_replace('/' . preg_quote($sub_name, '/') . '/', "", $table_column['current_name'], 1)); ?>_-_<?php print_r($table_column['id']); ?>_-_<?php print_r($table_column['mode']); ?>_-_<?php print_r($dataGet['id']); ?>"].setDate(parseInt(this_elem.state.view.unixDate));
																								}
																							}
																						}
																					});
																					$fa_datetimepicker.push($fa_datetimepicker["#save_-_<?php print_r(preg_replace('/' . preg_quote($sub_name, '/') . '/', "", $table_column['current_name'], 1)); ?>_-_<?php print_r($table_column['id']); ?>_-_<?php print_r($table_column['mode']); ?>_-_<?php print_r($dataGet['id']); ?>"]);
																					<?php
																						if(strlen($dataGet[$table_column['current_name']]) && $dataGet[$table_column['current_name']]!=0){
																					?>
																						$fa_datetimepicker["#save_-_<?php print_r(preg_replace('/' . preg_quote($sub_name, '/') . '/', "", $table_column['current_name'], 1)); ?>_-_<?php print_r($table_column['id']); ?>_-_<?php print_r($table_column['mode']); ?>_-_<?php print_r($dataGet['id']); ?>"].setDate(parseInt("<?php print_r($dataGet[$table_column['current_name']]); ?>"));
																					<?php
																						}
																					?>
																				</script>
																		...
																		case '17':case 17://info search case 17 for see all things about this part
																			?>
																				<div id="save_-_<?php print_r(preg_replace('/' . preg_quote($sub_name, '/') . '/', "", $table_column['current_name'], 1)); ?>_-_<?php print_r($table_column['id']); ?>_-_<?php print_r($table_column['mode']); ?>_-_<?php print_r($dataGet['id']); ?>" class="slider slider-maker"></div>
																				<br>
																				<!-- <div id="sliderDouble" class="slider slider-primary mb-3"></div> -->
																				<label class="hide reset_data"><?php print_r(strlen($dataGet[$table_column['current_name']]) ? $dataGet[$table_column['current_name']]:0); ?></label>
																				<span class="form-text data-text text-center-custom m-i-i-column" data-text-en="<?php print_r($table_column['description_info_en']); ?>" data-text-fa="<?php print_r($table_column['description_info_fa']); ?>"><?php print_r($GLOBALS['user_language']=="en" ? $table_column['description_info_en']:$table_column['description_info_fa']); ?></span>
																				<script>
																					noUiSlider.create(document.getElementById('save_-_<?php print_r(preg_replace('/' . preg_quote($sub_name, '/') . '/', "", $table_column['current_name'], 1)); ?>_-_<?php print_r($table_column['id']); ?>_-_<?php print_r($table_column['mode']); ?>_-_<?php print_r($dataGet['id']); ?>'), {
																						start: parseInt("<?php print_r(strlen($dataGet[$table_column['current_name']]) ? $dataGet[$table_column['current_name']]:0); ?>"),
																						connect: true,
																		...
																		case '18':case 18://info search case 18 for see all things about this part
																			?>
																				<input id="save_-_<?php print_r(preg_replace('/' . preg_quote($sub_name, '/') . '/', "", $table_column['current_name'], 1)); ?>_-_<?php print_r($table_column['id']); ?>_-_<?php print_r($table_column['mode']); ?>_-_<?php print_r($dataGet['id']); ?>" type="text" class="form-control save_data_table <?php if($table_column['importants']){?>save_important<?php } ?> tagsinput" value="<?php print_r(preg_replace('/' . preg_quote($sub_name, '/') . '/', "", $dataGet[$table_column['current_name']], 1)); ?>" data-role="tagsinput" data-color="warning">
																				<label class="hide reset_data"><?php print_r($dataGet[$table_column['current_name']]); ?></label>
																				<span class="form-text data-text text-center-custom m-i-i-column" data-text-en="<?php print_r($table_column['description_info_en']); ?>" data-text-fa="<?php print_r($table_column['description_info_fa']); ?>"><?php print_r($GLOBALS['user_language']=="en" ? $table_column['description_info_en']:$table_column['description_info_fa']); ?></span>
																				<script>
																					$("#save_-_<?php print_r(preg_replace('/' . preg_quote($sub_name, '/') . '/', "", $table_column['current_name'], 1)); ?>_-_<?php print_r($table_column['id']); ?>_-_<?php print_r($table_column['mode']); ?>_-_<?php print_r($dataGet['id']); ?>").tagsinput();
																				</script>
																			<?php
																		break;
																		case '19':case 19://info search case 19 for see all things about this part
																			?>
																				<ckeditor id="save_-_<?php print_r(preg_replace('/' . preg_quote($sub_name, '/') . '/', "", $table_column['current_name'], 1)); ?>_-_<?php print_r($table_column['id']); ?>_-_<?php print_r($table_column['mode']); ?>_-_<?php print_r($dataGet['id']); ?>" type="number" class="form-control save_data_table <?php if($table_column['importants']){?>save_important<?php } ?>"><?php print_r(preg_replace('/' . preg_quote($sub_name, '/') . '/', "", $dataGet[$table_column['current_name']], 1)); ?></ckeditor>
																				<label class="hide reset_data"><?php print_r(preg_replace('/' . preg_quote($sub_name, '/') . '/', "", $dataGet[$table_column['current_name']], 1)); ?></label>
																				<span class="form-text data-text text-center-custom m-i-i-column" data-text-en="<?php print_r($table_column['description_info_en']); ?>" data-text-fa="<?php print_r($table_column['description_info_fa']); ?>"><?php print_r($GLOBALS['user_language']=="en" ? $table_column['description_info_en']:$table_column['description_info_fa']); ?></span>
																				<script>
																					$(document).ready(function () {
																	...
																	switch ($table_column['mode']) {//tables_mode_code
																				...
																				<label class="col-sm-12">
																					<div class="form-check">
																						<label class="form-check-label data-text" data-text-en='<input checked id="save_-_<?php print_r(preg_replace('/' . preg_quote($sub_name, '/') . '/', "", $table_column['current_name'], 1)); ?>_-_<?php print_r($table_column['id']); ?>_-_<?php print_r($table_column['mode']); ?>_-_<?php print_r($dataGet['id']); ?>_-_keep_old_password" class="form-check-input" type="checkbox"><span class="form-check-sign"></span> Keep the old password ?' data-text-fa='<input checked id="save_-_<?php print_r(preg_replace('/' . preg_quote($sub_name, '/') . '/', "", $table_column['current_name'], 1)); ?>_-_<?php print_r($table_column['id']); ?>_-_<?php print_r($table_column['mode']); ?>_-_<?php print_r($dataGet['id']); ?>_-_keep_old_password" class="form-check-input" type="checkbox"><span class="form-check-sign"></span> کلمه عبور قبلی نگهداری شود ؟'>
																							<input checked id="save_-_<?php print_r(preg_replace('/' . preg_quote($sub_name, '/') . '/', "", $table_column['current_name'], 1)); ?>_-_<?php print_r($table_column['id']); ?>_-_<?php print_r($table_column['mode']); ?>_-_<?php print_r($dataGet['id']); ?>_-_keep_old_password" class="form-check-input" type="checkbox"><span class="form-check-sign"></span>
																		...
																		case '7':case 7://info search case 7 for see all things about this part
																			?>
																				<label class="col-sm-12">
																					<div class="form-check">
																						<label class="form-check-label data-text" data-text-en='<input checked id="save_-_<?php print_r(preg_replace('/' . preg_quote($sub_name, '/') . '/', "", $table_column['current_name'], 1)); ?>_-_<?php print_r($table_column['id']); ?>_-_<?php print_r($table_column['mode']); ?>_-_<?php print_r($dataGet['id']); ?>_-_keep_old_file" class="form-check-input" type="checkbox"><span class="form-check-sign"></span> Keep the old file ?' data-text-fa='<input checked id="save_-_<?php print_r(preg_replace('/' . preg_quote($sub_name, '/') . '/', "", $table_column['current_name'], 1)); ?>_-_<?php print_r($table_column['id']); ?>_-_<?php print_r($table_column['mode']); ?>_-_<?php print_r($dataGet['id']); ?>_-_keep_old_file" class="form-check-input" type="checkbox"><span class="form-check-sign"></span> فایل قبلی نگهداری شود ؟'>
																							<input checked id="save_-_<?php print_r(preg_replace('/' . preg_quote($sub_name, '/') . '/', "", $table_column['current_name'], 1)); ?>_-_<?php print_r($table_column['id']); ?>_-_<?php print_r($table_column['mode']); ?>_-_<?php print_r($dataGet['id']); ?>_-_keep_old_file" class="form-check-input" type="checkbox"><span class="form-check-sign"></span>
															...
															<div class="col-md-2 pt-0 col-form-label text-center-custom <?php if($GLOBALS['user_language']=='fa'){?>label-on-left<?php }else{?>label-on-right<?php } ?>">
																<button onclick="cleanThis('save_-_<?php print_r(preg_replace('/' . preg_quote($sub_name, '/') . '/', '', $table_column['current_name'], 1)); ?>_-_<?php print_r($table_column['id']); ?>_-_<?php print_r($table_column['mode']); ?>_-_<?php print_r($dataGet['id']); ?>');" class="btn btn-warning custom-edit-buttons data-original-title clear_single_column" rel="tooltip" data-original-title-en="Clean this field !" data-original-title-fa="پاکسازی این فیلد !" data-original-title="<?php print_r($GLOBALS['user_language']=="en" ? "Clean this field !":"پاکسازی این فیلد !"); ?>" data-placement="top">
																	<i style="font-size: 24px !important;" class="fas fa-eraser"></i>
																</button>
																<button <?php if($table_column['mode']==6){ ?>disabled<?php } ?> onclick="resetThis('save_-_<?php print_r(preg_replace('/' . preg_quote($sub_name, '/') . '/', '', $table_column['current_name'], 1)); ?>_-_<?php print_r($table_column['id']); ?>_-_<?php print_r($table_column['mode']); ?>_-_<?php print_r($dataGet['id']); ?>');" class="btn btn-warning custom-edit-buttons data-original-title reset_single_column" data-original-title-en="Reset this field to the first !" data-original-title-fa="بازگشت به حالت اصلی این فیلد !" data-original-title="<?php print_r($GLOBALS['user_language']=="en" ? "Reset this field to the first !":"بازگشت به حالت اصلی این فیلد !"); ?>" rel="tooltip" data-placement="top">
																	<i style="font-size: 24px !important;" class="fas fa-undo-alt"></i>
																</button>
																<button onclick="saveThis('save_-_<?php print_r(preg_replace('/' . preg_quote($sub_name, '/') . '/', '', $table_column['current_name'], 1)); ?>_-_<?php print_r($table_column['id']); ?>_-_<?php print_r($table_column['mode']); ?>_-_<?php print_r($dataGet['id']); ?>',this)" class="btn btn-success custom-edit-buttons data-original-title save_single_column" rel="tooltip" data-original-title-en="Save this field !" data-original-title-fa="ذخیره این فیلد !" data-original-title="<?php print_r($GLOBALS['user_language']=="en" ? "Save this field !":"ذخیره این فیلد !"); ?>" data-placement="top">
																	<i style="font-size: 24px !important;" class="fas fa-save"></i>
																</button>
															</div>
														</div>
													<?php
				...
				<?php
					if($res_dataGet->rowCount()>1 && $rowCounter!=$res_dataGet->rowCount()){
				?>
					<hr class="mb-5">
				<?php
					}
