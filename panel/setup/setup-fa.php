	...
	<nav class="navbar navbar-expand-lg navbar-absolute navbar-transparent fixed-top">
		<div class="container-fluid">
			<div class="navbar-wrapper">
				...
				<a class="navbar-brand" href="javascript:void(0)">نصب دیتابیس</a>
			</div>
			...
			<div class="collapse navbar-collapse" id="navigation">
				<ul class="navbar-nav mr-auto">
					<li class="nav-item ">
						<a href="setup-en.php" class="nav-link">
						...
						<div class="col-md-5 ml-auto">
							<div class="info-area info-horizontal mt-5">
								...
								<div class="description">
									<h3 class="info-title">حساب کاربری</h3>
									<p class="description">
										اگر حساب کاربری برای اتصال به دیتابیس ندارید بسازید و نام کاربری و کلمه عبور آن را در فیلد مربوط وارد نمایید.
									</p>
								</div>
							</div>
							<div class="info-area info-horizontal">
								...
								<div class="description">
									<h3 class="info-title">دیتابیس</h3>
									<p class="description">
										اگر دیتابیس ندارید بسازید و نام آن را در فیلد وارد نمایید.
									</p>
								</div>
							</div>
							<div class="info-area info-horizontal">
								...
								<div class="description">
									<h3 class="info-title">پیکربندی</h3>
									<p class="description">
										مطمئن شوید که حساب کاربری را به دیتابیس اضافه کرده اید.
									</p>
								</div>
							</div>
							<div class="info-area info-horizontal">
								...
								<div class="description">
									<h3 class="info-title">هشدار</h3>
									<p class="description">
										مراقب باشید ممکن است این عملیات باعث حذف شدن دیتابیس قبلی شود اگر وجود داشته باشد.
									</p>
								</div>
							</div>
						</div>
						<div class="col-md-7 mr-auto">
							...
							<div class="card card-register card-white">
								<div class="card-header">
									...
									<h4 class="card-title">نصب</h4>
								</div>
								<div class="card-body">
									<form class="form" onSubmit="startProgress('fa'); return false;">
										<div class="input-group">
											...
											<input id="server-name" type="text" class="form-control input-setup" placeholder="آدرس سرور">
										</div>
										<div class="input-group">
											<div class="input-group-prepend">
												<div class="input-group-text">
											...
											<input id="table-name" type="text" class="form-control input-setup" placeholder="نام جدول">
										</div>
										<div class="input-group">
											<div class="input-group-prepend">
												<div class="input-group-text">
											...
											<input id="username" type="text" placeholder="نام کاربری" class="form-control input-setup">
										</div>
										<div class="input-group">
											<div class="input-group-prepend">
												<div class="input-group-text">
											...
											<input id="password" type="password" class="form-control input-setup" placeholder="کلمه عبور">
										</div>
										<div class="input-group">
											<div class="input-group-prepend">
												<div class="input-group-text">
											...
											<input id="host-email" type="text" class="form-control input-setup" placeholder="آدرس هاست ایمیل">
										</div>
										<div class="input-group">
											<div class="input-group-prepend">
												<div class="input-group-text">
											...
											<input id="username-email" type="text" class="form-control input-setup" placeholder="نام کاربری ایمیل">
										</div>
										<div class="input-group">
											<div class="input-group-prepend">
												<div class="input-group-text">
											...
											<input id="password-email" type="password" class="form-control input-setup" placeholder="کلمه عبور ایمیل">
										</div>
										<div class="input-group">
											<div class="input-group-prepend">
												<div class="input-group-text">
											...
											<input id="port-email" type="text" class="form-control input-setup" placeholder="پورت ایمیل (پیش فرض 587)">
										</div>
										<div class="input-group">
											<div class="input-group-prepend">
												<div class="input-group-text">
										...
										<div class="input-group">
											...
											<input id="panel-username" type="text" class="form-control input-setup" placeholder="نام کاربری لایسنس">
										</div>
										<div class="input-group">
											<div class="input-group-prepend">
												<div class="input-group-text">
											...
											<input id="panel-password" type="password" class="form-control input-setup" placeholder="کلمه عبور لایسنس">
										</div>
										<div class="input-group">
											<div class="input-group-prepend">
												<div class="input-group-text">
								...
								<div class="card-footer">
									<a href="javascript:void(0)" onclick="startProgress('fa');" class="btn btn-primary btn-round btn-lg submiter">پایان</a>
								</div>
							</div>
						</div>
					</div>
