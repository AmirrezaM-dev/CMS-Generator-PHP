...
<head>
	...
	<script>
        ...
        messagesArr['forgot']['8chr']="Password at least must be 8 characters";
	...
	<nav class="navbar navbar-expand-lg navbar-absolute navbar-transparent fixed-top">
		<div class="container-fluid">
			<div class="navbar-wrapper">
				...
				<a class="navbar-brand" href="javascript:void(0)">Reset password</a>
			</div>
			...
			<div class="collapse navbar-collapse" id="navigation">
				<ul class="navbar-nav ml-auto">
					<li class="nav-item ">
						<a href="reset-fa.php?token=<?php if(isset($_GET['token'])){print_r($token);} ?>" class="nav-link" style="font-family: IranSans !important;">
								...
								<div class="card-body">
									<div id="login-div" class="should-hide">
                                        ...
                                        <div class="input-group">
											...
											<input id="password" type="password" placeholder="New password" class="form-control input-login">
                                        </div>
                                        <div class="input-group">
											<div class="input-group-prepend">
												<div class="input-group-text">
											...
											<input id="re-password" type="password" placeholder="Repeat new password" class="form-control input-login">
										</div>
									</div>
								</div>
								<div class="card-footer">
									<div id="login-footer" class="should-hide">
										<a style="cursor: pointer;" id="reset-click" href="javascript:void(0)" class="btn btn-primary btn-lg btn-block mb-3">Submit</a>
										<div class="">
											<h6>
												<a href="login.php" class="link footer-link">Back to login</a>
											</h6>
                                        </div>
									</div>
								</div>
