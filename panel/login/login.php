...
<head>
	...
	<script>
		var messagesArr=[];
		messagesArr['forgot']=[];
		messagesArr['forgot']['success']="Your password has been sent to your email";
		messagesArr['forgot']['failed']="The entered email or username is not available";
...
<body class="login-page">
		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navigation">
				<ul class="navbar-nav ml-auto">
					<li class="nav-item ">
						<a href="login-rtl.php" class="nav-link" style="font-family: IranSans !important;">
	...
	<div class="wrapper wrapper-full-page ">
		<div class="full-page login-page ">
			...
			<div class="content">
				<div class="container">
					<div class="col-lg-4 col-md-6 ml-auto mr-auto">
						...
						<form class="form" onSubmit="$('#login-click').click();return false;">
								...
								<div class="card-body">
									<div id="login-div" class="should-hide">
										<div class="input-group">
											...
											<input id="username" type="text" class="form-control input-login" placeholder="Email">
										</div>
										<div class="input-group">
											<div class="input-group-prepend">
												<div class="input-group-text">
											...
											<input id="password" type="password" placeholder="Password" class="form-control input-login">
										</div>
									</div>
									<div id="forgot-div" class="should-hide hide">
										<div class="input-group">
											<div class="input-group-prepend">
												<div class="input-group-text">
													<i class="tim-icons icon-email-85"></i>
											...
											<input id="forgot" type="text" class="form-control input-login" placeholder="Email or Username">
										</div>
									</div>
									<div id="help-div" class="should-hide hide">
										<a style="cursor: pointer;" id="forgot-click" href="javascript:void(0)" class="btn btn-primary btn-lg btn-block mb-3">Forgot Password?</a>
										<a style="cursor: pointer;" id="call-click" href="https://www.amirntm.ir/contact/" class="btn btn-primary btn-lg btn-block mb-3">Contact with creator</a>
										<a style="cursor: pointer;" id="back-login-click" href="javascript:void(0)" class="btn btn-primary btn-lg btn-block mb-3">Back to login form</a>
									</div>
								</div>
								<div class="card-footer">
									<div id="login-footer" class="should-hide">
										<a style="cursor: pointer;" id="login-click" href="javascript:void(0)" class="btn btn-primary btn-lg btn-block mb-3">Submit</a>
										<div class="">
											<h6>
												<a href="javascript:void(0)" id="help-click" class="link footer-link">Need Help?</a>
											</h6>
										</div>
									</div>
								</div>
			...
			<footer class="footer">
				<?php $custom_lang="en";require_once("../footer-pages.php"); ?>
			</footer>
		</div>
	</div>
	<!--   Core JS Files   -->
