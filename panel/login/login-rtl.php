	...
	<nav class="navbar navbar-expand-lg navbar-absolute navbar-transparent fixed-top">
		<div class="container-fluid">
			<div class="navbar-wrapper">
				...
				<a class="navbar-brand" href="javascript:void(0)">صفحه ورود</a>
			</div>
			...
			<div class="collapse navbar-collapse" id="navigation">
				<ul class="navbar-nav mr-auto">
					<li class="nav-item ">
						<a href="login.php" class="nav-link" style="font-family: IranSans !important;">
								...
								<div class="card-body">
									<div id="login-div" class="should-hide">
										<div class="input-group">
											...
											<input id="username" type="text" class="form-control input-login" placeholder="پست الکترونیکی">
										</div>
										<div class="input-group">
											<div class="input-group-prepend">
												<div class="input-group-text">
											...
											<input id="password" type="password" placeholder="کلمه عبور" class="form-control input-login">
										</div>
									</div>
									<div id="forgot-div" class="should-hide hide">
										<div class="input-group">
											...
											<input id="forgot" type="text" class="form-control input-login" placeholder="ایمیل یا نام کاربری">
										</div>
									</div>
									<div id="help-div" class="should-hide hide">
										<a style="cursor: pointer;" id="forgot-click" href="javascript:void(0)" class="btn btn-primary btn-lg btn-block mb-3">بازیابی کلمه عبور</a>
										<a style="cursor: pointer;" target="_blank" id="call-click" href="https://www.amirntm.ir/contact/" class="btn btn-primary btn-lg btn-block mb-3">تماس با سازنده</a>
										<a style="cursor: pointer;" id="back-login-click" href="javascript:void(0)" class="btn btn-primary btn-lg btn-block mb-3">بازگشت به فرم ورود</a>
									</div>
								</div>
								<div class="card-footer">
									<div id="login-footer" class="should-hide">
										<a style="cursor: pointer;" id="login-click" href="javascript:void(0)" class="btn btn-primary btn-lg btn-block mb-3">ارسال</a>
										<div class="">
											<h6>
												<a href="javascript:void(0)" id="help-click" class="link footer-link">به کمک نیاز دارید؟</a>
											</h6>
										</div>
									</div>
								</div>
